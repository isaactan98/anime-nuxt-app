<template>
    ...
    <div class="min-h-screen mx-5 md:mx-0 relative" :style="{ top: topPosition + 'px' }">

        <div class="mb-4 min-h-[10vh] flex items-center">
            
        </div>
        <div class=" flex overflow-x-auto container mx-auto gap-3 py-4">
        ...
        <div class="my-5">
            <div class="flex justify-between text-white">
                <h1 class="mb-4 mx-4 text-lg subpixel-antialiased tracking-wide">Recent Release</h1>
            ...
            <div v-if="recentRelease != null && recentRelease.length > 0"
                class="flex overflow-x-auto gap-3 w-full snap-x scroll-smooth">
                <RecentReleaseComponent v-for="rr in recentRelease" :key="rr" :release="rr" class="snap-start" />
            </div>
            <div v-else class="flex overflow-x-auto gap-3 w-full snap-x scroll-smooth">
                <!-- <SpiningLoading></SpiningLoading> -->
                <LoadingAnimeCard v-for="i in 5" :key="i"></LoadingAnimeCard>
            </div>
        </div>

        <div class="mt-5 pb-8 text-white" v-if="server == 'gogoanime'">
            <h1 class="mb-4 mx-4 text-lg subpixel-antialiased tracking-wide">Top Airing</h1>
